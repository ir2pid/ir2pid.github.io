          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ui.getIconButton(FontAwesomeIcons.stackOverflow, () => {launch(data.stackoverflowUrl)}),
                  ui.getIconButton(FontAwesomeIcons.instagram, () => {launch(data.instagramUrl)}),
                  ui.getIconButton(FontAwesomeIcons.githubAlt, () => {launch(data.githubUrl)}),
